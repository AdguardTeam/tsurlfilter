...
import { TabFrameRequestContext, TabsApi } from '../../../../src/lib/mv3/tabs/tabs-api';
import { TabContext, TabInfo } from '../../../../src/lib/mv3/tabs/tab-context';
...
describe('TabsApi', () => {
    ...
    describe('updateTabMainFrameRule method', () => {
        it('should update tab context main frame rule', () => {
            ...
            jest.spyOn(engineApi, 'matchFrame').mockImplementationOnce(() => mainFrameRule);
