 ...
 * @param popupRuleText Rule text with $popup modifier.
...
const getGetBlockingResponseParamsData = (
    ...
    return {
        tabId: 1,
        eventId: '1',
        rule: ruleText ? new NetworkRule(ruleText, 0) : null,
        popupRule: popupRuleText ? new NetworkRule(popupRuleText, 0) : null,
        referrerUrl: '',
        requestUrl,
        requestType,
        contentType,
