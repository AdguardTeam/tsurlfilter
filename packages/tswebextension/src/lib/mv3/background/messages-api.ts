...
export class MessagesApi {
    ...
    private handleGetRemoveParamRules(
        ...
        if (!this.tsWebExtension.isStarted) {
            logger.debug('[tsweb.MessagesApi.handleGetRemoveParamRules]: tswebextension is not started.');
            return null;
        }
    ...
    private handleLogRemoveParamEvent(
        ...
        if (!this.tsWebExtension.isStarted) {
            logger.debug('[tsweb.MessagesApi.handleLogRemoveParamEvent]: tswebextension is not started.');
            return false;
        }
