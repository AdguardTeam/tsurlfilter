...
import { BACKGROUND_TAB_ID, CUSTOM_FILTERS_START_ID } from '../../common/constants';
 ...
 */
export class CosmeticApi extends CosmeticApiCommon<LogJsRulesParamsMv3> {
    /**
     ...
     * @param params Data for JS rule logging.
     */
    public logScriptRules(params: LogJsRulesParamsMv3): void {
     ...
     * @param tabId Tab id.
     * @param frameId Frame id.
     * @param withCss Whether to apply CSS styles.
     *
