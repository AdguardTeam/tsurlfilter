 ...
 */
export const stealthConfigValidator = zod
    .object({
        /**
 ...
 */
export const configurationValidator = zod
    .object({
        /**
         ...
         * Logging level.
         */
        logLevel: zod.enum([LogLevel.Error, LogLevel.Warn, LogLevel.Info, LogLevel.Debug, LogLevel.Verbose]).optional(),
