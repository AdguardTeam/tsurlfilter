...
export const configurationValidator = zod.object({
     ...
     *
     * If it is defined, Adguard will work for domains from the {@link blacklist} only.
     *
     * All other domains will be ignored. If {@link blacklist} is defined, {@link whitelist} will be ignored.
     */
