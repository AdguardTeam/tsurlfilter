    ...
    test.each(
        addAsProp([
            ...
            // string's quote mark is also occurs in the string as an escaped character
            {
                ...
                expected: [[TokenType.String, 0, 10]],
            },
            {
                actual: String.raw`"str\"str"`,
                expected: [[TokenType.String, 0, 10]],
            ...
            {
                actual: '"str\n',
                expected: [[TokenType.BadString, 0, 5]],
            },
            {
                actual: "'str\n",
                expected: [[TokenType.BadString, 0, 5]],
            ...
            {
                actual: '"str\r\n',
                expected: [[TokenType.BadString, 0, 6]],
            },
            {
                actual: "'str\r\n",
                expected: [[TokenType.BadString, 0, 6]],
