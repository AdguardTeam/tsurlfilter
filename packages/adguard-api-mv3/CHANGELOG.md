...
[2.0.3]: https://github.com/AdguardTeam/tsurlfilter/releases/tag/adguard-api-mv3-v2.0.3

## [2.0.2] - 2026-07-28

### Changed

- **Internal (non-breaking):** renamed the private `ruleSetsPath` to
  `rulesetsPath` to match `@adguard/tswebextension` `v5.0.0`. The public
  `AdguardApi` surface is unchanged.

[2.0.2]: https://github.com/AdguardTeam/tsurlfilter/releases/tag/adguard-api-mv3-v2.0.2
...
[2.0.1]: https://github.com/AdguardTeam/tsurlfilter/releases/tag/adguard-api-mv3-v2.0.1
