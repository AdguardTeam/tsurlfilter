import { RULE_INDEX_NONE } from '../constants';
import { type FilterListSourceMap } from '../filter';

import { findNextLineBreakIndex } from './string';
 ...
 */
export function getRuleSourceText(lineStartIndex: number, source: string): string | null {
 ...
 */
export function getRuleSourceIndex(ruleIdx: number, sourceMap: FilterListSourceMap): number {
