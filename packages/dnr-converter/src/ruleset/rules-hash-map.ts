/**
 * @file Contains the RulesHashMap class for fast rule matching
 * by hash, used for $badfilter checking.
 */

import { type SourceRuleIdxAndFilterId } from './source-map';

// This type is used only to better describe code.
type RuleHash = number;

/**
 * Hash of source rule to fast check applicability of $badfilter rule.
...
/**
 * Interface for rules hash map operations.
 */
...
export class RulesHashMap implements IRulesHashMap {
    /**
     * Map of rule hashes to their sources.
     */
