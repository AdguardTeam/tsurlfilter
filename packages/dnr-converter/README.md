...
[license-url]: https://github.com/AdguardTeam/tsurlfilter/blob/master/packages/dnr-converter/LICENSE
...
- `$urltransform` — limited; complex transforms produce multiple declarative
  rules via pipeline stages
