...
- Preserve `$csp` allowlist rules in source-map ruleset metadata for MV3 runtime
  exception planning.

### Fixed

- Prevent `$csp` allowlist rules from being converted into broad DNR `allow` rules.
