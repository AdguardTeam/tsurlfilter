 ...
 * @param {ByteRange} [range] Optional byte range to specify in the HTTP request.
 *
 ...
 * @param {ByteRange} [range] Optional byte range to specify in the HTTP request.
 *
 * @returns {Promise<string>} A promise that resolves to the fetched content as a string.
 */
