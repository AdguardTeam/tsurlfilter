...
type NetworkOptionValidator = {
     ...
     */
    customChecks?: ((r: IndexedNetworkRuleWithHash, name: string) => UnsupportedModifierError | null)[],
    /**
...
export class NetworkRuleDeclarativeValidator {
     ...
     * @returns Error {@link UnsupportedModifierError} or null if rule is supported.
     */
    private static checkAllowRulesFn(r: IndexedNetworkRuleWithHash, name: string): UnsupportedModifierError | null {
     ...
     * @returns Error {@link UnsupportedModifierError} or null if rule is supported.
     */
    private static checkHasModifierExplicitlyFn(
        r: IndexedNetworkRuleWithHash,
        name: string,
    ): UnsupportedModifierError | null {
     ...
     */
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    private static checkMethodModifierFn(r: IndexedNetworkRuleWithHash, name: string): UnsupportedModifierError | null {
     ...
     */
    public static shouldConvertNetworkRule(rule: IndexedNetworkRuleWithHash): boolean {
