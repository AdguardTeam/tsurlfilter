...
export class NetworkRule implements IRule {
     ...
     *
     * The reader must be bound to a context that was populated for a
     * network-classified rule. Host-rule candidates must be routed through the
     * AST path (see {@link RuleFactory.createRule}); host-shaped input with a
     * space in the pattern is rejected by the constructor.
     *
