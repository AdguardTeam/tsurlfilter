...
describe('CssTokenStream', () => {
    ...
    describe('hasAnySelectorNativeAndExtCssNode', () => {
        describe('should return false for native CSS', () => {
            test.each([
                [String.raw`div`],
                [String.raw`div > a`],
                ...
                const stream = new CssTokenStream(input);
                expect(stream.hasAnySelectorNativeAndExtCssNode()).toBe(false);
            });
        });
        ...
        describe('should return true for native-and-ext CSS (:has, :is, :not)', () => {
            test.each([
                ...
                const stream = new CssTokenStream(input);
                expect(stream.hasAnySelectorNativeAndExtCssNode()).toBe(true);
            });
        });
    });
