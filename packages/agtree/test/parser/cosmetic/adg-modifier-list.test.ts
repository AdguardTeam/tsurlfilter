                ...
                expected: (context: NodeExpectContext): ElementHidingRule => {
                    return {
                        ...
                        domains: DomainListParser.parse(
                            '',
                            defaultParserOptions,
                            String.raw`[$domain=/example[0-9]\.(com|org)/]`
                                .length,
                        ),
                        modifiers: {
                            type: 'ModifierList',
                            children: [
                                {
                                    ...
                                    value: {
                                        ...
                                        ...context.getRangeFor(
                                            String.raw`/example[0-9]\.(com|org)/`,
                                        ),
                                    },
                                },
                            ],
                ...
                expected: (context: NodeExpectContext): ElementHidingRule => {
                    return {
                        ...
                        domains: DomainListParser.parse(
                            '',
                            defaultParserOptions,
                            String.raw`[$domain=/example\d{1,}\.(com|org)/]`
                                .length,
                        ),
                        modifiers: {
                            type: 'ModifierList',
            ...
            },
            {
                ...
                expected: (context: NodeExpectContext): AdblockSyntaxError => {
                    return new AdblockSyntaxError(
                        ...
                        ...context.toTuple(
                            context.getRangeFor('path=/something]example.com'),
                        ),
                    );
                },
            },
