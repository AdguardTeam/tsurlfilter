 ...
 */
const toBeConvertedProperlyNew = (
    received: unknown,
    ...
    try {
        ...
        ruleNode = pipeline.parse(receivedParsed.actual, parserOptions);
    } catch (error: unknown) {
        return {
            pass: false,
...
expect.extend({
    toBeConvertedProperlyNew,
});

export type ToBeConvertedProperlyNew = typeof toBeConvertedProperlyNew;
