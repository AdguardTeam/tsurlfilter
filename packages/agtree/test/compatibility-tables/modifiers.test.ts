...
} from '../../src/compatibility-tables/modifiers';
import {
    GenericPlatform,
    SpecificPlatform,
...
describe('Modifiers Compatibility Table', () => {
    it('modifiersCompatibilityTable.existsAny', () => {
        ...
        expect(
            modifiersCompatibilityTable.existsAny('nonexistent'),
        ).toBeFalsy();
    });

    it('modifiersCompatibilityTable.exists', () => {
        expect(
            modifiersCompatibilityTable.exists(
                '_',
        ...
        expect(
            modifiersCompatibilityTable.exists('_', GenericPlatform.AdgExtAny),
        ).toBeTruthy();
        expect(
            modifiersCompatibilityTable.exists(
                'nonexistent',
    ...
    it('modifiersCompatibilityTable.getSingle', () => {
        expect(
            modifiersCompatibilityTable.getSingle(
                'third-party',
                SpecificPlatform.AdgExtChrome,
            ),
    ...
    it('modifiersCompatibilityTable.getMultiple', () => {
        expect(
            modifiersCompatibilityTable.getMultiple(
                'third-party',
