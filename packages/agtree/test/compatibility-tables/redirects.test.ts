...
} from '../../src/compatibility-tables/redirects';
...
describe('Redirects Compatibility Table', () => {
    it('redirectsCompatibilityTable.existsAny', () => {
        ...
        expect(
            redirectsCompatibilityTable.existsAny('nonexistent'),
        ).toBeFalsy();
    });

    it('redirectsCompatibilityTable.exists', () => {
        expect(
            redirectsCompatibilityTable.exists(
                'noopjs',
    ...
    it('redirectsCompatibilityTable.getSingle', () => {
        expect(
            redirectsCompatibilityTable.getSingle(
                'noopjs',
                SpecificPlatform.AdgExtChrome,
            ),
    ...
    it('redirectsCompatibilityTable.getMultiple', () => {
        expect(
            redirectsCompatibilityTable.getMultiple(
                'noopjs',
                GenericPlatform.AdgExtAny,
            ),
        ).toMatchObject({
    ...
    describe('googlesyndication-adsbygoogle redirect', () => {
        ...
        it('should resolve googlesyndication.com/adsbygoogle.js alias for ADG platform', () => {
            ...
            expect(
                redirectsCompatibilityTable.existsAny(REDIRECT_ALIAS),
            ).toBeTruthy();
            expect(
                redirectsCompatibilityTable.exists(
                    REDIRECT_ALIAS,
