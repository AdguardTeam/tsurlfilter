...
describe('CosmeticRuleSeparator', () => {
    describe('isException', () => {
        test.each([
            ...
            expect(CosmeticRuleSeparatorUtils.isException(separator)).toBe(
                expected,
            );
        });
    });
    ...
    describe('isExtendedCssMarker', () => {
        test.each([
            ...
            expect(
                CosmeticRuleSeparatorUtils.isExtendedCssMarker(separator),
            ).toBe(expected);
        });
    });
    ...
    test('find', () => {
        ...
        expect(
            CosmeticRuleSeparatorUtils.find('example.com##.ad'),
        ).toMatchObject(<CosmeticRuleSeparatorFinderResult>{
            separator: '##',
            start: 11,
            end: 13,
        });
        ...
        expect(
            CosmeticRuleSeparatorUtils.find('example.com,example.org#@#.ad'),
        ).toMatchObject(<CosmeticRuleSeparatorFinderResult>{
            separator: '#@#',
            start: 23,
            end: 26,
        ...
        expect(
            CosmeticRuleSeparatorUtils.find(
                'example.com,example.org#?##ad:contains(ad)',
            ),
        ).toMatchObject(<CosmeticRuleSeparatorFinderResult>{
            separator: '#?#',
            start: 23,
        ...
        expect(
            CosmeticRuleSeparatorUtils.find(
                'example.com,example.org#$##ad { padding-top: 0px !important }',
            ),
        ).toMatchObject(<CosmeticRuleSeparatorFinderResult>{
            separator: '#$#',
            start: 23,
        ...
        expect(
            CosmeticRuleSeparatorUtils.find(
                "example.com,example.org#%#//scriptlet('scriptlet', 'param0')",
            ),
        ).toMatchObject(<CosmeticRuleSeparatorFinderResult>{
            separator: '#%#',
            start: 23,
        ...
        expect(
            CosmeticRuleSeparatorUtils.find(
                'example.com,example.org$$script[tag-content="advert"]',
            ),
        ).toMatchObject(<CosmeticRuleSeparatorFinderResult>{
            separator: '$$',
            start: 23,
        ...
        expect(
            CosmeticRuleSeparatorUtils.find(
                'example.com,example.org#%#var a = 1;',
            ),
        ).toMatchObject(<CosmeticRuleSeparatorFinderResult>{
            separator: '#%#',
            start: 23,
        ...
        expect(
            CosmeticRuleSeparatorUtils.find(
                'example.com$$script[tag-content="#example"]',
            ),
        ).toMatchObject(<CosmeticRuleSeparatorFinderResult>{
            separator: '$$',
            start: 11,
        ...
        expect(
            CosmeticRuleSeparatorUtils.find('127.0.0.1 localhost ## comment'),
        ).toBeNull();
    });
});
