...
describe('CosmeticRuleSeparator', () => {
    ...
    test('find', () => {
        // Elemhide
        expect(CosmeticRuleSeparatorUtils.find('##.ad')).toMatchObject(<CosmeticRuleSeparatorFinderResult>{
            separator: '##',
            start: 0,
            end: 2,
        });

        expect(CosmeticRuleSeparatorUtils.find('example.com##.ad')).toMatchObject(<CosmeticRuleSeparatorFinderResult>{
            separator: '##',
            start: 11,
            end: 13,
        });
        ...
        // ADG HTML
        expect(CosmeticRuleSeparatorUtils.find('example.com,example.org$$script[tag-content="advert"]')).toMatchObject(<
            CosmeticRuleSeparatorFinderResult
        >{
            separator: '$$',
            start: 23,
