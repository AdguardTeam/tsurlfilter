...
import { SelectorListParser } from '../../../src/parser-new/cosmetic/selector-list';
import { NodeExpectContext, type NodeExpectFn } from '../../helpers/node-utils';

describe('SelectorListParser (parser-new)', () => {
    describe('SelectorListParser.parse - valid cases', () => {
        test.each<{ actual: string; expected: NodeExpectFn<SelectorList> }>([
            ...
            // NOTE: the new preparser-based parser preserves raw backslash-escape sequences in value
            {
    ...
    describe('SelectorListParser.parse - invalid cases', () => {
        test.each<{ actual: string; expected: NodeExpectFn<AdblockSyntaxError> }>([
            ...
            // NOTE: preparser reports position one past end of string
            {
                actual: 'div+',
                expected: () => (new AdblockSyntaxError(
            ...
            // NOTE: preparser sees 'quotes' as an invalid flag identifier
            {
