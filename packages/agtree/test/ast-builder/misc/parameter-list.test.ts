...
import { ParameterListAstBuilder } from '../../../src/ast-builder/misc/parameter-list';
import { createParserContext, initParserContext } from '../../../src/parser/context';
import { ParameterListParser, PL_BUFFER_SIZE } from '../../../src/parser/misc/parameter-list';
...
/**
 * Tokenize, parse, and build a ParameterList AST from an inner source string
...
function parse(source: string, isLocIncluded = false) {
    ...
    ParameterListParser.parse(ctx, 0, tokenizer.tokenCount, 0, source.length, plBuf);
    return ParameterListAstBuilder.parse(source, plBuf, isLocIncluded);
}

describe('ParameterListAstBuilder', () => {
