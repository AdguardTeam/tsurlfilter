...
/**
 * @file CSS rule preparser data layout constants.
 *
 ...
 *
 * After the header, sub-preparser regions follow contiguously:
 *   [dataOffset + CR_HEADER_SIZE .. + CR_HEADER_SIZE + SL_MIN_DATA_SLOTS - 1]:
 *       selector list preparser region
 *   [dataOffset + CR_HEADER_SIZE + SL_MIN_DATA_SLOTS ..]:
 *       declaration list preparser region
 */
...
/**
 * Number of header slots used by the rule preparser.
 */
export const CR_HEADER_SIZE = 12;

/**
 * Minimum buffer capacity for the rule preparser, including sub-preparser
