...
/**
 * @file CSS declaration list preparser.
 *
 * `DeclarationListPreparser.preparse()` consumes adblock tokens directly and
...
/**
 * CSS declaration list preparser.
 *
 ...
 * heap allocations.
 */
export class DeclarationListPreparser {
    /**
    ...
    /**
     * Number of declarations in the preparsed list.
     *
