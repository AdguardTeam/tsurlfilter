...
export class NetworkRuleConverter extends RuleConverterBase {
    ...
    public static convertToAdg(
        rule: AnyNetworkRule,
    ): NodeConversionResult<NetworkRule> {
        ...
        if (rule.modifiers) {
            const modifiers = NetworkRuleModifierListConverter.convertToAdg(
                rule.modifiers,
                rule.exception,
            );
    ...
    public static convertToUbo(
        ...
        if (rule.modifiers) {
            const modifiers = NetworkRuleModifierListConverter.convertToUbo(
                rule.modifiers,
                rule.exception,
            );
