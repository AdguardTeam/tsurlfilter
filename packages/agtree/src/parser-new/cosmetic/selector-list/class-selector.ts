 ...
 *
 * Builds a ClassSelector AST node from a preparsed child record.
 */
...
/**
 * Build a ClassSelector AST node from a preparsed child record.
 *
 * The value excludes the leading '.' character — the preparser stores offsets
