 ...
 *
 * Builds a SelectorCombinator AST node from a preparsed child record.
 */
...
/**
 * Lookup table mapping preparser combinator encoding to string values.
 *
 * Index matches the `COMBINATOR_*` constants from the preparser.
...
/**
 * Build a SelectorCombinator AST node from a preparsed child record.
 *
