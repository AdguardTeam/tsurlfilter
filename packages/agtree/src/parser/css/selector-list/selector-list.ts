...
/**
 * @file CSS selector list parser — top-level dispatcher.
 *
 * `SelectorListParser.parse()` consumes adblock tokens directly (no
...
export class SelectorListParser {
    ...
    public static parse(
        ...
        while (ti < endTi) {
            ...
            if (tt === TokenType.Comma) {
                ...
                SelectorListParser.writeComplexRecord(
                    ctx.data,
                    dataOffset,
                    complexCount,
                    childCountInComplex,
    ...
    /**
     * Number of complex selectors in the parsed selector list.
     *
     * @param data Output buffer.
     * @param dataOffset Base offset for selector-list data.
     *
    ...
    public static childKind(
        ...
        const base = SelectorListParser.childBase(dataOffset, maxComplex, childIdx);
