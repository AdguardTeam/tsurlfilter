...
import { cloneDomainListNode, cloneModifierListNode, cloneScriptletRuleNode } from '../../ast-utils-new/clone';
import { parseDomainList } from '../../ast-utils-new/parsing';
import {
    getScriptletName,
    setScriptletName,
