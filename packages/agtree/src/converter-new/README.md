...
The new converter API is available by the `@adguard/agtree/converter-new` entrypoint:
...
`@adguard/agtree/converter`. All new development should use `converter-new`.
...
import { RuleConverter } from '@adguard/agtree/converter-new';
import { RuleGenerator } from '@adguard/agtree/generator-new';
...
import { FilterListConverter } from '@adguard/agtree/converter-new';
import { FilterListGenerator } from '@adguard/agtree/generator-new';
