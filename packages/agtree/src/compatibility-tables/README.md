...
| `adg_os_cli`      | <img src="https://cdn.adguard.com/website/github.com/AGLint/adg_logo.svg" alt="AdGuard logo" width="14px"> [AdGuard for Linux](https://adguard.com/adguard-linux/overview.html)                                                                | System-wide ad blocker |
...
| `adg_os_any`          | Any AdGuard OS-wide app (using [CoreLibs](https://github.com/AdguardTeam/CoreLibs)) | `adg_os_windows`, `adg_os_mac`, `adg_os_cli`, `adg_os_android`  |
