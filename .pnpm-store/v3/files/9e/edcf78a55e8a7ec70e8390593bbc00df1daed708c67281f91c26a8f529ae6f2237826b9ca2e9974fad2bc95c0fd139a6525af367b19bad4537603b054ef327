...
class RE2 {
    constructor(pattern, flags, maxMem) {
        ...
        this.wrapper = new re2_1.WrappedRE2(translateRegExp(pattern, this._multiline), this._ignoreCase, this._multiline, this._dotAll, maxMem !== null && maxMem !== void 0 ? maxMem : 0);
        if (!this.wrapper.ok()) {
